...
exports.fetchFollowings = void 0;
var db_1 = require("../../utils/db");
var fetchFollowings = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user, error_1;
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                return [2 /*return*/, res.status(200).json({
                        ...
                        data: {
                            users: user === null || user === void 0 ? void 0 : user.following
                        }
                    })];
            case 2:
                error_1 = _a.sent();
