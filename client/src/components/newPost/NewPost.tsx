...
import { CircularProgress, InputLabel, TextareaAutosize, TextField } from "@material-ui/core";
      ...
      <Box className={classes.top_nav_post}>
        ...
        <Box sx={{ mr: 1 }}>
          <Button
            ...
            disabled={Boolean(filename.length && content.length !== 0? false : true)}
          >
            Post
          </Button>
        </Box>
...
export default NewPost;
            ...
            {/* <Box sx={{display: 'inline-flex', alignItems: 'center'}}>
              ...
              <TextField
              type="text"
              placeholder="sepreate it by ,"
              onChange={e => setCategory(e.target.value)}
              value={category}
              className={classes.category_field}
              />
            </Box> */}
