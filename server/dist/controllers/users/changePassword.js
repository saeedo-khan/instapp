...
var changePassword = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, currentPassword, newPassword, currentUser, user, matchPassword, hashPwd, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 4, , 5]);
                _a = req.body, currentPassword = _a.currentPassword, newPassword = _a.newPassword, currentUser = _a.currentUser;
            ...
            case 1:
                user = _b.sent();
                matchPassword = (0, password_util_1.checkPassword)(currentPassword, newPassword);
                if (!matchPassword) {
                    return [2 /*return*/, res.status(401).json({ message: "current password is incorrect" })];
                }
                return [4 /*yield*/, (0, password_util_1.hashPassword)(newPassword)];
            case 2:
                hashPwd = _b.sent();
