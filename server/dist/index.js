...
var storage = new multer_storage_cloudinary_1.CloudinaryStorage({
    ...
    params: {
        folder: 'instapp',
        public_id: function (req, file) { return Math.random(); }
    }
});
var multerUplaod = (0, multer_1["default"])({ storage: storage });
var uploadFiels = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
